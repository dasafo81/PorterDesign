...
import {
  generateClientEmail, generateSewingOrderPDF, generateSimplifiedPDF
} from './lib/pdf.js';
  ...
  // ── SUMMARY ──
    ...
    content=ce(Fragment,null,
      ...
      ce("div",{style:{display:"flex",gap:10,flexWrap:"wrap"}},
        ...
        ce("button",{onClick:function(){var __m=(+montazInput||+(curClient&&curClient.install_fee)||0)/100;generateOfferPDF(curClient,comm,__m);},style:{padding:"14px 20px",borderRadius:12,border:"none",background:"var(--gr)",color:"#fff",fontSize:14,fontWeight:600,cursor:"pointer",letterSpacing:"0.03em",minHeight:52}},"\uD83D\uDCC4 Wycena PDF"),
        ce("button",{onClick:function(){var __m=(+montazInput||+(curClient&&curClient.install_fee)||0)/100;generateSimplifiedPDF(curClient,comm,__m);},style:{padding:"14px 20px",borderRadius:12,border:"none",background:"#c8956c",color:"#fff",fontSize:14,fontWeight:600,cursor:"pointer",letterSpacing:"0.03em",minHeight:52}},"\uD83D\uDCCB Wycena Uproszczona"),
