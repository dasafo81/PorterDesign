  ...
  function handleSend(){
    ...
    if(appItems.length>0&&selClient){
      var appPdfPromises=appItems.map(function(att){
        ...
        // Logo/banner sa placeholderami az do tego momentu (base64 siedzi w osobnym
        // chunku ladowanym dynamicznie) — bez tego zalacznik poszedlby bez grafiki.
        return resolvePDFAssets(finalHtml).then(function(resolvedHtml){
