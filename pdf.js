...
export function buildSimplifiedPDFHtml(client,comm,montaz,variantLabel){
  ...
  var h="<!DOCTYPE html><html lang=\"pl\"><head><meta charset=\"UTF-8\"><title>"+client.name+" - Oferta Aranżacji Okiennych"+variantSuffix+"</title>"+pdfStyles()+"</head><body>"
    ...
    +(montaz>0?"<div style=\"margin-bottom:3mm;padding:10px 14px;background:#e8e8e4;border-radius:8px;display:flex;justify-content:space-between;align-items:center;\"><span style=\"font-size:12px;color:#555;font-weight:600;\">\u0141\u0105cznie bez monta\u017cu:</span><span style=\"font-size:14px;font-weight:700;color:#555;\">"+roundTo10(grandTotal2)+" z\u0142</span></div>":"")
